...
export default async function DashboardPage() {
  ...
  const stats = [
    { title: "Total Bookings", value: totalBookings ?? 0, icon: CalendarDays },
    { title: "Active Rentals", value: activeBookings ?? 0, icon: Car },
    { title: "Agreements", value: totalAgreements ?? 0, icon: FileText },
  ]
